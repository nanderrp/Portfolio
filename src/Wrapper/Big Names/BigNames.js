        ...
        return (
            <div className="BigNames container-fluid">
                ...
                <Link className="BigNames-link" to='/Linkedin'>
                    <span style={{textDecoration: 'underline !important'}} className='Name'>Linkedin</span>
                    <span style={{textDecoration: 'underline  !important'}} className='Text'>: Sponsored Inmail Email</span>  <img src={Lock} alt="..."className="Lock"></img>
                </Link>
